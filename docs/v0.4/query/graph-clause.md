...
[`_pgrdf_graphs`](/v0.4/storage/named-graphs) mapping table to a
...
## 🚀 v0.5 forward edge — variable graph

`GRAPH ?g { … }` (a **variable** graph) — joining across all
graphs and projecting the graph IRI as a solution variable — is
in the v0.4 cycle, landing as Phase A slice 113. See

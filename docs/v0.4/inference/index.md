...
- [**Mental model**](/v0.4/inference/mental-model) — how to think
  about materialization in pgRDF.
- [**Worked example**](/v0.4/inference/example) — subclass-chain
  walkthrough you can run in psql.
- [**OWL 2 RL rule set**](/v0.4/inference/owl-rl-rules) — what
  the reasoner actually entails.
- [**Idempotence + operator safety**](/v0.4/inference/idempotence) —
  guarantees you can rely on for scheduled jobs.
- [**🚀 Forward edge — profile selector**](/v0.4/inference/profile-selector) —
...
[**Next — Mental model →**](/v0.4/inference/mental-model)

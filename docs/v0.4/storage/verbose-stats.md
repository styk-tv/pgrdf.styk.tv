...
- **Data scientists** — verify the [shared-memory dictionary cache](/v0.4/storage/shmem-cache)
...
[`pgrdf.stats()`](/v0.4/operations/stats); its dictionary-cache
...
- [Bulk ingest](/v0.4/storage/bulk-ingest).

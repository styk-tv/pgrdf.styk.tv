...
- [**Mental model**](/v0.4/validation/mental-model).
- [**Worked example**](/v0.4/validation/example) — minCount,
  datatype, nodeKind constraints.
- [**SHACL Core components**](/v0.4/validation/shacl-components) —
  what's supported.
- [**Report as data**](/v0.4/validation/report-as-data) — querying
  violations with regular SQL.
- [**🚀 Forward edge — SHACL-SPARQL**](/v0.4/validation/shacl-sparql) —
...
[**Next — Mental model →**](/v0.4/validation/mental-model)

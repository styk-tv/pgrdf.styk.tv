...
| Component | Status |
|---|---|
| SHACL-SPARQL constraint components (`sh:sparql`, `sh:select`, `sh:ask`) | 🚀 v0.5 — see [Forward edge](/v0.4/validation/shacl-sparql). |
| Property paths with full expressivity (alternation, sequence, inverse beyond simple) | v0.5 alongside the [SPARQL property-path](/v0.4/query/roadmap) work. |

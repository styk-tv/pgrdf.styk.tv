...
- [Lifecycle UDFs overview](/v0.6/storage/lifecycle).
- [`copy_graph`](/v0.6/storage/copy-graph) — the row-copying half.
- [`drop_graph`](/v0.6/storage/drop-graph) — the partition-removing half.
- [`clear_graph`](/v0.6/storage/clear-graph) — pair with

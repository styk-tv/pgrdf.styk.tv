...
[materialised-closure no-CTE fast path](/v0.6/query/property-paths#materialised-closure-no-cte-fast-path)
...
- Seven `#[pg_test]` cases lock UPDATE-detail fields
...
- [SPARQL UPDATE](/v0.6/query/update) — full write surface.
- [Error-message contract](/v0.6/query/error-contract).
